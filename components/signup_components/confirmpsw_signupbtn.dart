...
class ConfirmPasswordTextFieldSignUp extends StatefulWidget {
  const ConfirmPasswordTextFieldSignUp({super.key});

  @override
  _PasswordTextFieldState createState() => _PasswordTextFieldState();
}

class _PasswordTextFieldState extends State<ConfirmPasswordTextFieldSignUp> {
